...
) : BaseUseCase<NotificationRequestDTO, String, String>(appDataStoreManager) {

    override suspend fun run(params: NotificationRequestDTO, token: String) = service.readNotification(
        token = token,
        requestDTO = params
    )
