...
fun AturPinScreen(
    ...
    DefaultScreenUI(
        ...
        parent = true,
        titleToolbar = "Atur Pin",
        startIconToolbar = Icons.AutoMirrored.Filled.ArrowBack,
        onClickStartIconToolbar = popup
    ) {
        AturPinContent(
            progressBarState = state.progressBarState,
            navigateToKonfirmasi = navigateToKonfirmasi
        )
    }
}

@Composable
private fun AturPinContent(
    navigateToKonfirmasi: () -> Unit,
    ...
    Column(
        ...
        Text(
            "Atur PIN", style = MaterialTheme.typography.bodyMedium.copy(
                fontWeight = FontWeight.Bold
            )
        )
        Text(
            "Masukkan 6 digit PIN untuk bertransaksi",
