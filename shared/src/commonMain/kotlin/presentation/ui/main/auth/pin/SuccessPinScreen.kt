...
private fun SuccessPinContent(
    ...
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(Res.drawable.ic_success_pin_figma),
            ...
            Text(
                text = "Pin Ceria Berhasil Dibuat!",
                style = MaterialTheme.typography.headlineSmall,
                fontWeight = FontWeight.Bold,
                textAlign = TextAlign.Center
            )
            ...
            Text(
                text = "Sekarang kamu bisa lebih mudah dan aman menikmati semua fitur Banten Ceria",
